...
# Run proguard.
java -jar ../../bin/proguard/proguard4.11/lib/proguard.jar -injars a.normal.jar -outjars a.proguard.jar -keep public class a -optimizationpasses 9 -overloadaggressively
